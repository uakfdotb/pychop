...
public:
	...
	virtual uint32_t UserCount( string server );
	virtual bool UserAdd( string server, string name, uint32_t access );
	virtual bool UserDelete( string server, string user );
	virtual vector<CUser *> UserList( string server );
	virtual bool UserSetSeen( string server, string name );
	virtual uint32_t UserSeen( string server, string name );
...
//  - you should deliver any to-be-orphaned callables to the main vector in CChOP so they can be properly deleted when ready even if you don't care about the result anymore
...
class CCallableUserCount : virtual public CBaseCallable
{
protected:
	string m_Server;
	uint32_t m_Result;
...
public:
	CCallableUserCount( string nServer ) : CBaseCallable( ), m_Server( nServer ), m_Result( 0 ) { }
	virtual ~CCallableUserCount( );
...
class CCallableUserAdd : virtual public CBaseCallable
{
protected:
	string m_Server;
	string m_Name;
...
public:
	CCallableUserAdd( string nServer, string nName, uint32_t nAccess ) : CBaseCallable( ), m_Server( nServer ), m_Name( nName ), m_Access( nAccess ), m_Result( false ) { }
	virtual ~CCallableUserAdd( );

	virtual string GetServer( )				{ return m_Server; }
	virtual string GetName( )				{ return m_Name; }
	virtual uint32_t GetAccess( )			{ return m_Access; }
	virtual bool GetResult( )				{ return m_Result; }
	virtual void SetResult( bool nResult )	{ m_Result = nResult; }
};

class CCallableUserDelete : virtual public CBaseCallable
{
protected:
	string m_Server;
	string m_Name;
...
public:
	CCallableUserDelete( string nServer, string nName ) : CBaseCallable( ), m_Server( nServer ), m_Name( nName ), m_Result( false ) { }
	virtual ~CCallableUserDelete( );
...
class CCallableUserList : virtual public CBaseCallable
{
protected:
	string m_Server;
	map<string, CUser *> m_Result;

public:
	CCallableUserList( string nServer ) : CBaseCallable( ), m_Server( nServer ) { }
	virtual ~CCallableUserList( );

	virtual string GetServer( )								{ return m_Server; }
	virtual map<string, CUser *> GetResult( )				{ return m_Result; }
	virtual void SetResult( map<string, CUser *> nResult )	{ m_Result = nResult; }
};

class CCallableUserSetSeen : virtual public CBaseCallable
{
protected:
	string m_Server;
	string m_Name;
...
public:
	CCallableUserSetSeen( string nServer, string nName ) : CBaseCallable( ), m_Server( nServer ), m_Name( nName ), m_Result( false ) { }
	virtual ~CCallableUserSetSeen( );
...
class CCallableUserSeen : virtual public CBaseCallable
{
protected:
	string m_Server;
	string m_Name;
...
public:
	CCallableUserSeen( string nServer, string nName ) : CBaseCallable( ), m_Server( nServer ), m_Name( nName ), m_Result( 0 ) { }
	virtual ~CCallableUserSeen( );
